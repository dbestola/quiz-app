...
var QuestionBank = [
    ...
    {
        question: 'Q.3 How many ethnic groups do we have in Nigeria?',
        options: ['300', '450', '350', '250'],
        answer: '250',
      },
      {
        question: 'Q.4 All but one of the following is not a symbol of political culture',
        options: ['The government', 'An anthem', 'National flag', 'The constitution'],
        answer: 'The government',
      },
      {
        question: 'Q.5 In politics, power is all of the following EXCEPT',
      ...
      {
        question: 'Q.6 One of the destructive features of a democracy is that it',
      ...
      {
        question: 'Q.7 Which of the following best describes French colonial policy in Africa?',
        options: ['policy assimilation', 'policy of casus belli', 'policy of hostility', 'policy of association'],
        answer: 'policy assimilation',
      },
      {
        question: 'Q.8 A political concept that defines the beliefs, attitudes and values of a society is called',
